...
enum httpStatusCodes {
	...
	CLIENT_ERROR_IM_A_TEAPOT = 418, // IETF April Fools' joke
	...
	CLIENT_ERROR_NO_RESPONSE = 444, // Nginx
	CLIENT_ERROR_RETRY_WITH = 449, // Microsoft
	CLIENT_ERROR_BLOCKED_BY_WINDOWS_PARENTAL_CONTROLS = 450, // Microsoft
	CLIENT_ERROR_UNAVAILABLE_FOR_LEGAL_REASONS = 451,
	CLIENT_ERROR_REQUEST_HEADER_TOO_LARGE = 494, // Nginx
	CLIENT_ERROR_CERT_ERROR = 495, // Nginx
	CLIENT_ERROR_NO_CERT = 496, // Nginx
	CLIENT_ERROR_HTTP_TO_HTTPS = 497, // Nginx
	CLIENT_ERROR_CLIENT_CLOSED_REQUEST = 499, // Nginx
	...
	SERVER_ERROR_NETWORK_READ_TIMEOUT_ERROR = 598, // Nginx
	SERVER_ERROR_NETWORK_CONNECT_TIMEOUT_ERROR = 599, // Nginx
}
